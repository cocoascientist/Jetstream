...
internal class LocationManagerSubscription<SubscriberType: Subscriber>: NSObject, CLLocationManagerDelegate, Subscription where SubscriberType.Input == Result<[CLLocation], Error> {
...
internal struct LocationPublisher: Publisher {
