...
internal enum GeocoderError: Error {
    case notFound
    case other(Error)
}

internal class ReverseGeocoderSubscription<SubscriberType: Subscriber>: Subscription where SubscriberType.Input == Result<[CLPlacemark], GeocoderError> {
...
internal struct ReverseGeocoderPublisher: Publisher {
